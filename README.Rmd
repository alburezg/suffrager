...
Images for `london`, `oxon`, `CarolMan`, `chelsea`, and `classic` used with kind permission from the [LSE Womens Library Collection](http://www.lse.ac.uk/library/collections/collection-highlights/womens-suffrage)
 and 
